...
async def c(callback: CallbackQuery):
    ...
    crasm = FSInputFile("images/c.png")
    await callback.message.answer_photo(photo=crasm, caption=
...
async def cpp(callback: CallbackQuery):
    ...
    await callback.message.answer_photo(photo=image, caption="C++ dasturlash tili 1983-yilda Bjarne Stroustrup tomonidan C tiliga asoslanib yaratilgan. ", reply_markup=os_back)
    log_action(callback.from_user, "OS → C++ tilini tanladi")
...
async def rust(callback: CallbackQuery):
    rustam = FSInputFile("images/rust.png")
    log_action(callback.from_user, "OS → Rust tilini tanladi")
    await callback.message.answer_photo(photo=rustam, caption=
...
async def go(callback: CallbackQuery):
    gost = FSInputFile("images/go.png")
    log_action(callback.from_user, "OS → Go tilini tanladi")
    await callback.message.answer_photo(photo=gost, caption=
...
async def swift(callback: CallbackQuery):
    swiftie = FSInputFile("images/swift.png")
    log_action(callback.from_user, "OS → Swift tilini tanladi")
    await callback.message.answer_photo(photo=swiftie, caption=
...
async def web_py(callback: CallbackQuery):
    ...
    wpython = FSInputFile("images/python.png")
    await callback.message.answer_photo(photo=wpython, caption=
...
async def web_js(callback: CallbackQuery):
    webjs = FSInputFile("images/js.png")
    log_action(callback.from_user, "Web → JavaScript tanladi")
    await callback.message.answer_photo(photo=webjs, caption=
...
async def web_ts(callback: CallbackQuery):
    ts = FSInputFile("images/Typescript_logo_2020.svg")
...
async def web_php(callback: CallbackQuery):
    phpi = FSInputFile("images/php.png")
    log_action(callback.from_user, "Web → PHP tanladi")
    await callback.message.answer_photo(photo=phpi, caption=
...
async def web_ruby(callback: CallbackQuery):
    rubyi = FSInputFile('images/ruby.png')
    log_action(callback.from_user, "Web → Ruby tanladi")
    await callback.message.answer_photo(photo=rubyi, caption=
...
async def web_java(callback: CallbackQuery):
    wjava = FSInputFile("images/java.png")
    log_action(callback.from_user, "Web → Java tanladi")
    await callback.message.answer_photo(photo=wjava, caption=
...
async def web_cs(callback: CallbackQuery):
    csi = FSInputFile("images/c#.png")
    log_action(callback.from_user, "Web → C# tanladi")
    await callback.message.answer_photo(photo=csi, caption=
...
async def web_kot(callback: CallbackQuery):
    wkot = FSInputFile("images/kot.png")
...
async def sec_python(callback: CallbackQuery):
    pythonw=FSInputFile("images/python.png")
    log_action(callback.from_user, "Security → Python tanladi")
    await callback.message.answer_photo(photo=pythonw, caption=
...
async def sec_c(callback: CallbackQuery):
    ci = FSInputFile("images/c.png")
    log_action(callback.from_user, "Security → C tanladi")
    await callback.message.answer_photo(photo=ci, caption=
...
async def sec_cpp(callback: CallbackQuery):
    cpi = FSInputFile("images/cpp.png")
    log_action(callback.from_user, "Security → C++ tanladi")
    await callback.message.answer_photo(photo=cpi, caption=
...
async def sec_go(callback: CallbackQuery):
    goi=FSInputFile("go.png")
    log_action(callback.from_user, "Security → Go tanladi")
    await callback.message.answer_photo(photo=goi, caption=
...
async def sec_rust(callback: CallbackQuery):
    rusty=FSInputFile("images/rust.png")
    log_action(callback.from_user, "Security → Rust tanladi")
    await callback.message.answer_photo(photo=rusty, caption=
...
# Main loop
async def main():
    await bot.send_message(chat_id=shakwul, text="Nagap boti ishlatvardim")
    await bot.send_animation(chat_id=nodir_uztoz, animation="images/gif.gif")
    await bot.send_message(chat_id=nodir_uztoz, text="Yo'qay tashamman ustoz")
